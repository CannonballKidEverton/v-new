...
export const ENGAGEMENT_POOL: Engagement[] = [
  { ref: 'M.2025/04', city: 'UAE', mandate: 'Enterprise CRM deployment', sector: 'Real estate',           status: 'deployed',    statusLabel: 'Deployed'     },
  ...
  { ref: 'M.2026/02', city: 'KSA', mandate: 'Operating counsel',         sector: 'Family office',        status: 'structuring', statusLabel: 'Structuring'  },
  ...
  { ref: 'M.2026/06', city: 'UAE', mandate: 'GTM design',                sector: 'D2C commerce',         status: 'delivery',    statusLabel: 'In delivery'  },
];
