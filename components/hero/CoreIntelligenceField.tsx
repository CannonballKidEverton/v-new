...
export function CoreIntelligenceField() {
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      /* Compositional anchor: right-of-centre, slightly above mid */
      CX = W * 0.635; CY = H * 0.420;
    }
    ...
    function draw() {
      ...
      /* 1 — Core warm glow */
      const cg = ctx!.createRadialGradient(ox, oy, 0, ox, oy, sc(248) + breath * 20);
      cg.addColorStop(0.00, `rgba(215,138,46,${.36 + breath * .10})`);
      cg.addColorStop(0.20, `rgba(175,104,32,${.17 + breath * .05})`);
      cg.addColorStop(0.50,  'rgba(118,68,18,0.07)');
